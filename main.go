...
func createSnippet(w http.ResponseWriter, r *http.Request) {
	...
	// If it's not, use the w.WriteHeader() method to send a 405 status code and // the w.Write() method to write a "Method Not Allowed" response body. We
